...
# NOTE: lerobot is imported lazily inside create_torch_dataset() rather than at module scope, so that
# importing this module does not require lerobot to be installed. The DSRL/online path never needs it;
# only the LeRobot training path (e.g. pi05_libero_hitl_lora) does.
import numpy as np
import torch
